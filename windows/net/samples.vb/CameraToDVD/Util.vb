...
Namespace CameraToDVD
    ...
    Friend NotInheritable Class Util
        ...
        Private Shared ColorSpaceTab() As ColorSpaceEntry = {New ColorSpaceEntry(MediaSubType.RGB24, ColorFormat.BGR24), New ColorSpaceEntry(MediaSubType.ARGB32, ColorFormat.BGR32), New ColorSpaceEntry(MediaSubType.RGB32, ColorFormat.BGR32), New ColorSpaceEntry(MediaSubType.RGB565, ColorFormat.BGR565), New ColorSpaceEntry(MediaSubType.ARGB1555, ColorFormat.BGR555), New ColorSpaceEntry(MediaSubType.RGB555, ColorFormat.BGR555), New ColorSpaceEntry(MediaSubType.ARGB4444, ColorFormat.BGR444), New ColorSpaceEntry(MediaSubType.YV12, ColorFormat.YV12), New ColorSpaceEntry(MediaSubType.I420, ColorFormat.YUV420), New ColorSpaceEntry(MediaSubType.IYUV, ColorFormat.YUV420), New ColorSpaceEntry(MediaSubType.YUY2, ColorFormat.YUY2), New ColorSpaceEntry(MediaSubType.NV12, ColorFormat.NV12), New ColorSpaceEntry(MediaSubType.UYVY, ColorFormat.UYVY), New ColorSpaceEntry(MediaSubType.Y411, ColorFormat.Y411), New ColorSpaceEntry(MediaSubType.Y41P, ColorFormat.Y41P), New ColorSpaceEntry(MediaSubType.YVU9, ColorFormat.YVU9)}
        ' tested mappings
        ' possible mappings
        ' unknown mappings
        '{ ?,		ColorFormat::YUV411		},
        ...
        Public Shared Function GetUnconnectedPin(ByVal filter As IBaseFilter, ByVal pinDir As PinDirection, <System.Runtime.InteropServices.Out()> ByRef ppPin As IPin) As Integer
            ...
            Try
                ...
                Do While enumPins.Next(1, pins, IntPtr.Zero) = 0
                    Dim thisPinDir As PinDirection
        ...
        Public Shared Function CheckRecorderDevices(ByVal recorder As VideoRecorder, <System.Runtime.InteropServices.Out()> ByRef activeCount As Integer, <System.Runtime.InteropServices.Out()> ByRef failedCount As Integer, <System.Runtime.InteropServices.Out()> ByRef noSpaceCount As Integer) As Boolean
            activeCount = 0
            failedCount = 0
            noSpaceCount = 0

            For i As Integer = 0 To recorder.Devices.Count - 1
                Dim err As PrimoSoftware.DVDBuilder.ErrorInfo = recorder.GetDeviceError(i)
                If err.Facility <> PrimoSoftware.DVDBuilder.ErrorFacility.Success Then
                    If err.Facility = PrimoSoftware.DVDBuilder.ErrorFacility.VRDevice AndAlso err.Code = CInt(Fix(VRDeviceError.OutOfFreeSpace)) Then
                        noSpaceCount += 1
                    Else
                        failedCount += 1
                    End If
        ...
        Public Shared Function CheckRecorderDevices(ByVal recorder As VideoRecorder) As Boolean
            Dim activeCount As Integer
            Dim failedCount As Integer
            Dim noSpaceCount As Integer

            Return CheckRecorderDevices(recorder, activeCount, failedCount, noSpaceCount)
        End Function
    End Class
End Namespace
